...
> **Status: v0.1, v0.2, and v0.5 shipped; ADR 0004 perf gap closed; v1.0 in progress (compression, EnTT adapter, and interactive browser viewer shipped — CI perf gate and API stability sign-off remain).**
